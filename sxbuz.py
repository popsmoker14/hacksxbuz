...
if(expirydate>today):
    ...
    print(" 1.  2000 INR -------  1 Day (20 Games")
    ...
    while(True):
        ...
        if(bhai==code or bhai==test or bhai==code1 or bhai==code2):
            ...
            print("15th May 2022, 02:30 PM - 03:00 PM")
#             print("15th May 2022, 05:30 PM- 06:00 PM")
#             print("15th May 2022, 08:30 PM- 09:00 PM")
            ...
            system(banner)
            print("----------Your play time-----------")
            print("16th-1st may 2021, 02:00 PM- 02:30 PM")
            print("17th-1st may 2021, 06:00 PM- 06:30 PM")
            print("18th-1st may 2021, 08:30 PM- 09:00 PM")
            print("Please play on the given time, and ")
            print("If you think it is an error contact")
            print("wait.... starting....")
            time.sleep(20)
            ...
            clear()
            print("----------Your play time-----------")
            print("16th May 2022,  08:00 PM- 08:30 PM")
            print("17th May 2022, 08:00 PM- 08:30 PM")
            print("18th May 2022, 08:00 PM- 08:30 PM")
            print("Please play on the given time, and ")
            print("If you think it is an error contact")
            print("wait.... starting....")
            time.sleep(20)
